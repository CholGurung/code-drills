...
// write if statement to check if characterOneName is equal to "Mr. farley"
    ...
    // if it does === Mr. farley then console.log a string of hello Mr. farley

    // write a else if and check if characterOneName === "Ms. Farley"

    // if it does === Ms. farley then console.log a string of hello Ms. farley
...
// write if statement check if characterOneAge greter than characterTwoAge
    ...
    // if characterOneAge is greater than characterTwoAge then console.log a string of  Mr. farley
...
// write if statement check if characterOneRent greater than characterTwoRent
...
// write if statement check if characterOneExpenses greater than characterTwoExpenses
